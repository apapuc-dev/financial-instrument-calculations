...
@Service
public class Instrument2Calculator implements InstrumentCalculatorWithSupport {
    private double priceSum = 0;
    private int instrumentsCount = 0;

    @Override
    public Instrument getSupportedInstrument() {
        return Instrument.INSTRUMENT_2;
    }
    ...
    public void addDataPoint(InstrumentPricePoint instrumentPricePoint) {
        ...
        if (date.getMonth().equals(Month.NOVEMBER) && date.getYear() == 2014) {
